        ...
        <GuestLayout>
            ...
            <div className='flex gap-3 items-center mb-4 justify-center'>
                <div className='w-12 h-12 overflow-hidden'>
                    <img src={LogoKemahasiswaan} alt="Logo Kemahasiswaan" className='w-full h-full object-cover' />
                </div>
                <div>
                    <p className='text-primary font-bold text-xl'>Sistem Informasi Prestasi Mahasiswa</p>
