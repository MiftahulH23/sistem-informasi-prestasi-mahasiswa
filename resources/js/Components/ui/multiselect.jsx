...
const MultipleSelector = ({
    ...
    useEffect(() => {
        ...
        // Pakai event click + capture phase agar lebih powerful di mobile
            ...
            >
                <div className="flex flex-wrap gap-1">
                    {selected.map((option) => {
                        return (
                            ...
                            >
                                {option.label}
                                <button
                                    className="text-muted-foreground/80 hover:text-foreground absolute -inset-y-px -end-px flex size-7 items-center justify-center rounded-e-md border border-transparent p-0 outline-hidden transition-[color,box-shadow] outline-none "
                                    onKeyDown={(e) => {
                                        if (e.key === "Enter") {
                    ...
                    <CommandPrimitive.Input
                        ...
                        className={cn(
                            "placeholder:text-muted-foreground/70 flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed focus-visible:!ring-transparent !border-transparent h-7",
                            {
                                "w-full": hidePlaceholderWhenSelected,
                                "px-3 h-9": selected.length === 0,
                    ...
                    <button
                        ...
                        className={cn(
                            "text-muted-foreground/80 hover:text-foreground  absolute end-0 top-0 flex size-9 items-center justify-center rounded-md border !border-transparent transition-[color,box-shadow] outline-none",
                            (hideClearAllButton ||
                                disabled ||
                                selected.length < 1 ||
