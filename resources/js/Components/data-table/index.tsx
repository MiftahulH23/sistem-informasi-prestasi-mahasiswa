...
import type { DataTable, DataTableControls } from "./types";
            ...
            {search && (
                <div className="relative h-full">
                    <Input
                        ...
                        className="@3xl:w-52 z-10 w-40 pe-6 ps-8 selection:bg-blue-600"
                        onChange={(e) =>
...
export function DataTable<Data, Value>(props: DataTable<Data, Value>) {
    const {
        columns,
        data,
        children,
    ...
    // dont render if page size is not loaded
                    ...
                    <TableBody className="bg-white">
                        {table.getRowModel().rows?.length ? (
                            table.getRowModel().rows.map((row) => (
                                <TableRow
                                    className="odd:bg-[#F8FAFC] even:bg-[#E3F2FD] text-center"
                                    key={row.id}
                                    data-state={
